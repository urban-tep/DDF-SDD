...
extensions = ['githubpath', 'sphinxcontrib.plantuml', 'sphinx.ext.autodoc', 'req', 'sphinx.ext.todo']
...
project = u'Urban Thematic Exploitation Platform Software Design Document'
copyright = u'2015, Terradue'
...
htmlhelp_basename = 'UrbanTEP-SDD'
...
latex_documents = [
  ('index', 'UrbanTEP-SDD.tex', u'Urban Thematic Exploitation Platform Software Design Document',
   r'Emmanuel Mathot (T2)\\Martin Boettcher (BC)\\Thomas Esch (DLR)\\Stepan Kuchar (IT4I)\\Julian Zeidler (DLR)', 'manual', True),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '_static/logo-urban-big.png'
...
pdf_cover_template = '../_styles/cover.tmpl'
# Documents to append as an appendix to all manuals.
#pdf_appendices = []
