Terradue Software packages
^^^^^^^^^^^^^^^^^^^^^^^^^^

Here is all the software packages developed and maintainded by Terradue
...
.. toctree::
   ...
   Terradue::OpenSearch::SciHub <../namespaces//namespace_terradue_1_1_open_search_1_1_sci_hub>
   Terradue::OpenSearch::RdfEO <../namespaces//namespace_terradue_1_1_open_search_1_1_rdf_e_o>
